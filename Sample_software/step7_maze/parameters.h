...
#define REF_SEN_R	1200				//1200//マウスを迷路中央に置いた時のセンサの値
#define REF_SEN_L	1200				//1200//マウスを迷路中央に置いた時のセンサの値

#define TH_SEN_R	50				//50//壁があるか否かの閾値	車体を区画の左へ寄せた時のセンサ値(壁あり)
#define TH_SEN_L	45				//50//壁があるか否かの閾値	車体を区画の右へ寄せた時のセンサ値(壁あり)
#define TH_SEN_FR	50				//50//壁があるか否かの閾値	
#define TH_SEN_FL	50				//50//壁があるか否かの閾値
...
#define SPEED_KP	(35.0)				//Pゲイン(20.0)
#define SPEED_KI	(0.3)				//Iゲイン(0.20)
#define SPEED_KD	(0.0)				//Dゲイン(0.0)
//車体中心における回転方向速度に関するフィードバックゲイン
#define OMEGA_KP	(30.0)				//Pゲイン(20.0)
#define OMEGA_KI	(0.25)				//Iゲイン(0.2)
#define OMEGA_KD	(0.0)				//Dゲイン(0.0)

//走行パラメータ
#define SEARCH_SPEED	(0.25)				//探索走行の速度	[m/s]
...
#define GOAL_Y	6		//ゴール座標(y)
#define STARTL_X 0		//スタート座標(x)
#define STARTL_Y 0		//スタート座標(y)
